...
const LandingPhoto = () =>{
    ...
    return(
        <div className="top-0 h-1/3 lg:h-1/2  overflow-hidden bg-cover bg-header-picture relative py-32">
     ...
     {/* <div className="top-0 h-1/3 lg:h-1/2  overflow-hidden relative">
            <img className="w-full absolute object-cover"  src="/static/images/foodies.jpg/"/>
