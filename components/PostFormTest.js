...
function PostFormTest(){
    ...
    <div className={`absolute min-h-[400px] left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 shadow bg-white w-full  lg:w-2/5 sm:w-4/5 ${modalSize} z-50 py-5 px-9`}>

                            <div>
                                     <p as="h3" className="text-lg leading-6 font-medium text-gray-900 text-center mb-5">
                                        {finishPhotoPick ? 
                            ...
                            <div className="h-4/5   w-full relative ">
                                    ...
                                    <div className=" relative w-full h-1/3  ">
                                        <div className="w-full h-full flex items-center">
                                                <div
                                                    ...
                                                    className="mx-auto flex items-center justify-center h-12 w-40 rounded-md bg-red-100
                                                    cursor-pointer"
                                                    >   
                                ...
                                <div className=" h-4/5 w-full relative">
                                        ...
                                        <div className="mb-10">
                                            <input
                                                className="border-b-2 border-gray-400 focus:border-black focus:outline-none  w-1/4 text-xl"
                                                type="text"
                                                ref={captionRef}
                                        ...
                                        <div className="text-lg leading-6 font-medium text-gray-900  mb-5">
                                            ...
                                            <ChevronDownIcon className={showIngredience ? "inline-block w-6 h-6 rotate-180 cursor-pointer" : "inline-block w-6 h-6 cursor-pointer" } onClick={showIngredienceBox}/>
                                        </div>
                                        
                                        <div className={showIngredience ? "flex items-center mb-5" : "hidden"}>
                                            <input
                                                className="border-b-2 border-gray-400 focus:border-black focus:outline-none w-1/4"
                                                type="text"
                                                ref={captionTwoRef}
                                            ...
                                            />
                                            {addButton ? (
                                                <PlusCircleIcon className="inline-block w-8 h-8 cursor-pointer ml-3" onClick={addIgredience} / >
                                            ):(<></>)}                                                                                      
                                             
                                        </div>
                                        <div className={showIngredience ? "max-h-[150px] overflow-y-scroll scrollbar-thin scrollbar-thumb-black mb-5" : "h-0 w-0 overflow-hidden"}>
                                            <div className="">
                                            {ingredience.length ? (
                                        ...
                                        <div className="text-lg leading-6 font-medium text-gray-900 mt-10  mb-5">
                                        ...
                                        <textarea 
                                                    className="h-40 w-full overflow-y-scroll scrollbar-thin scrollbar-thumb-black max-h-[200px] border border-gray-400"
                            ...
                            <div className="w-full relative ">
                                <div className="w-full flex place-content-between items-center">
                                    <div className="w-10 h-10">
                                        {finishPhotoPick &&(
                                            <ArrowLeftIcon onClick={finishPhotoPicking} className="w-10 h-10 hover:text-red-400 cursor-pointer" />
                                        )}
                                    ...
                                    {!finishPhotoPick && selectedFile.length > 0 ?(
                                        <ArrowRightIcon onClick={finishPhotoPicking} className="w-10 h-10 hover:text-red-400 cursor-pointer" />
                                    ):(<></>)}
                                    </div>
